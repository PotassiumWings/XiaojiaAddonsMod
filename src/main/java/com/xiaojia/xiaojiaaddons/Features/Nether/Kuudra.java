...
public class Kuudra {
    ...
    static {
        ...
        personalInfos.add(new KuudraInfo("Detonate", new HashMap<Integer, Integer>(){{
            put(1, 50);put(2, 80);put(3, 110);put(4, 140);
        }}));
    ...
    public void onTick(TickEndEvent event) {
        ...
        display2.setRenderLoc(Configs.KuudraX + 120, Configs.KuudraY);
        display3.setRenderLoc(Configs.KuudraX + 240, Configs.KuudraY);
    ...
    private static String getStringFromInfo(KuudraInfo info) {
        ...
        String colorString = getColorStringFromTier(tier, info.cost.size());
